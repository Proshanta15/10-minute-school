        ...
        <>
            <Slider {...settings}>
                ...
                <div className="mentor">
                    ...
                    <div className="mentor_title">
                        <h5 className="card-title">Sabiha Nishy</h5>
                        <p className="card-text"> Sher-e-Bangla Agricultural</p>                     
                    </div> 
                </div>
                <div className="mentor">
                    <div className="mentor_img"> 
                    ...
                    <div className="mentor_title">
                        <h5 className="card-title">Fatima Prova</h5>
                        <p className="card-text">JU</p>                     
                    </div> 
                </div>
                <div className="mentor">
                    <div className="mentor_img"> 
